            ...
            <div className="row justify-content-center">
               <div className="col-xl-x col-lg-8 col-md-10">
                  <div className={`section-title text-center ${style ? "text-white mb-55" : "mb-60"}`}>
                     ...
                     <p>From Ghana and beyond, get to know whats really happening on the grounds from this section of our page.</p>
                  </div>
               </div>
            </div>
                     ...
                     <div className="blog-item">
                        ...
                        <div className="blog-item__content">
                           <ul className="blog-meta">
                              <li><i className="flaticon-user"></i> <Link href="#">Afful Warren</Link></li>
                              <li><i className="flaticon-bubble-chat"></i> <Link href="#">05 Comment</Link></li>
                           </ul>
                           <h4><Link href={`blog-clasics/${item.id}`}>{item.title}</Link></h4>
                           <p>{item.desc}</p>
                           <Link href={`blog-clasic/${item.id}`} className="read-more">Read More</Link>
                        </div>
                     </div>
                  </div>
               ))}
                  ...
                  <div key={item.id} className="col-xl-4 col-md-6">
                     <div className={`blog-item blog-item--two ${item.item_bg}`}>
                        ...
                        <div className="blog-item__content">
                           ...
                           <h4><Link href={`blog-clasics/${item.id}`}>{item.title}</Link></h4>
                           <p>{item.desc}</p>
                           <Link href={`blog-clasics/${item.id}`} className="read-more">Read More</Link>
                        </div>
                     </div>
                  </div>
               ))}
