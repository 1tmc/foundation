      ...
      <form onSubmit={handleSubmit(onSubmit)}>
         <div className="row">
            <div className="col-xl-9 mb-10">
               <p>Is there anything you will like to know? Please contact us below.</p>
            </div>
            ...
            <div className="col-md-12">
               <div className="form-group">
                  ...
                  <textarea {...register("message")} id="message" className="form-control" rows={2} placeholder="Write Your Message"></textarea>
