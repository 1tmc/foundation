      ...
      <div className="donation-form">
         <div className="row">
            <div className="col-lg-12">
               ...
               <p><strong>Bank Name:</strong> Bank Of Africa</p>
               <p><strong>Account Number:</strong> 04246900004</p>
               <p><strong>Account Name:</strong> Christ Impact Lives Foundation</p>
               {/* <p><strong>SWIFT Code:</strong> ABCD1234</p> */}
            </div>

            <div className="col-lg-12">
               <h5>Mobile Money (MoMo) Details</h5>
               <p><strong>MoMo Number:</strong> +233 123 456 789</p>
               <p><strong>Account Name:</strong> Christ Impact Lives Foundation</p>
            </div>
