...
const footer_content: ContentData = {
   footer_about_text: (<>Thank You for taking your time to visit our website. We hope and pray our causes touch you enough to join us in changing the world and making it a better place.</>),
