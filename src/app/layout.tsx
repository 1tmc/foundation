...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="description" content="Leading Foundation that is rooted in supporting the challenged Single mothers and Children. We are located in Accra Ghana." />
